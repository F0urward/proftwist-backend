...
SELECT 
    ...
    c.id,
    'UX дизайн',
    'Исследование пользователей, Персоны, Карты пути пользователя, Юзабилити-тестирование, Информационная архитектура',
    true
...
SELECT 
    ...
    'Контент-стратегия, Дизайн навигации, Таксономия, Карты сайта, Карточная сортировка',
    true
FROM "user" u, category c WHERE u.username = 'admin' AND c.name = 'UI/UX';
