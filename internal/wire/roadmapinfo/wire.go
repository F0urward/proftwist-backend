...
func InitializeRoadmapInfoHttpServer(cfg *config.Config, log logger.Logger, mtrs metrics.Metrics) *httpServer.HttpServer {
	wire.Build(
		ClientsSet,
		RoadmapInfoSet,
		AllHttpRegistrars,
...
func InitializeRoadmapInfoGrpcServer(cfg *config.Config, log logger.Logger, mtrs metrics.Metrics) *grpcServer.GrpcServer {
	wire.Build(
		ClientsSet,
		RoadmapInfoSet,
		AllGrpcRegistrars,
